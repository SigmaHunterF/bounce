...
var spawntime: int = 1
var spawntimepizza: int = 1
var wavebar: int = 0
var slime = preload("uid://cfkuy28luyru2")
var pizzashooter = preload("uid://bpwg7gf4x57am")
...
# Add it to the scene tree
	...
	if time > spawntimepizza:
		var pizza_instance = pizzashooter.instantiate()
		
		var random_x = randf_range(-519, 679)
		var random_y = randf_range(-615, 343)
		pizza_instance.position = Vector2(random_x, random_y)
		
		add_child(pizza_instance)
